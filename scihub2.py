...
proxies_list = ['61.220.26.97:80','35.196.26.166:3128','187.35.137.97:3128','147.135.210.114:5486','219.101.183.51:']
...
class SciHub(object):
    ...
    def search(self, query, limit=10, download=False):
        ...
        while True:
            try:
                res = requests.get(SCHOLARS_BASE_URL, params={'q': query, 'start': start}, headers=HEADERS,proxies=Proxies)
